        ...
        <div class="main-body">
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-12">
                        <div id="wizard3">
                            <form class="wizard-form" id="design-wizard" action="{{ route('admin.users.update',$user->id)}}" method="POST">
                                  @csrf
                                @method('put')             
                                  <div class="form-group row">
                                      <div class="col-sm-3">
                                        <label for="datejoin" class="block">User Name</label>
                                      </div>
                                      <div class="col-sm-5">
                    ...
                    />
                                  ...
                                  <div class="form-group row">
                                      <div class="col-sm-3">
                                        <label for="datejoin" class="block">User Email</label>
                                      </div>
                                      <div class="col-sm-5">
                    ...
                    />
                                                       ...
                                                       <div class="form-group row">
                                      <div class="col-sm-3">
                                        <label for="datejoin" class="block">User Password</label>
                                      </div>
                                      <div class="col-sm-5">
                    ...
                    />
                                ...
                                <div class="form-group row">
                                      <div class="col-sm-3">
                                        <label for="datejoin" class="block">Confirm Password</label>
                                      </div>
                                      <div class="col-sm-5">
                    ...
                    />
                                ...
                                <div class="form-group row">
                                      <div class="col-sm-3">
                                        <label for="datejoin" class="block">User Role</label>
                                      </div>
                                      <div class="col-sm-5">
